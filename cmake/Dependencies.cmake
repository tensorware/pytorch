...
elseif(BLAS STREQUAL "OpenBLAS")
    if(NOT INTERN_BUILD_MOBILE)
        ...
        # Use external OpenBLAS with LAPACK build in
        include(${CMAKE_CURRENT_LIST_DIR}/External/OpenBLAS.cmake)
        include_directories(SYSTEM ${OPEN_BLAS_INCLUDE_DIR})
        list(APPEND Caffe2_DEPENDENCY_LIBS openblas)
        set(BLAS_INFO "open")
        set(BLAS_FOUND 1)
        set(USE_BLAS 1)
        set(LAPACK_FOUND 1)
        set(USE_LAPACK 1)
        message(STATUS "Using OpenBLAS in directory: ${OPEN_BLAS_SRC_DIR}")
    endif()
